...
export default function ProjectDashboard({ params }: { params: { slug: string } }) {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div
        style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px', marginTop: '24px' }}
      >
        <Card>
          <CardHeader>
            ...
            >
              {ARTIFACT_TYPES.map(a => (
                ...
                >
                  ...
                  <Link
                    href={`/project/${params.slug}/documents`}
                    style={{
                      padding: '4px 10px',
                      borderRadius: '6px',
          ...
          <Card>
            ...
            <CardContent>
              <div style={{ textAlign: 'center', padding: '24px 16px' }}>
                ...
                <div style={{ fontSize: '0.8125rem', color: '#9CA3AF', marginTop: '4px' }}>
                  Start the pipeline to begin generating.
                </div>
              </div>
            </CardContent>
          </Card>
