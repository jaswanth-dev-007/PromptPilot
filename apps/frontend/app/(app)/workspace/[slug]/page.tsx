...
export default function WorkspaceDashboard({ params }: { params: { slug: string } }) {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div
        style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '24px' }}
      >
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <EmptyState
              ...
              action={{ label: 'New Project', href: '/projects' }}
            />
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <EmptyState
              ...
              description="Start a pipeline to begin generating documents."
            />
          </CardContent>
        </Card>
        <Card>
...
function EmptyState({
  ...
  return (
    <div style={{ textAlign: 'center', padding: '40px 16px' }}>
      ...
      <div
        style={{ fontSize: '0.875rem', color: '#9CA3AF', marginTop: '6px', marginBottom: '16px' }}
      >
        {description}
      </div>
      {action && (
