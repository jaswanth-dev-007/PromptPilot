      ...
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            Click any step to see the type of output PromptPilot generates. Every document is real
            content from an actual PromptPilot run.
          </p>
        </div>
        ...
        <div style={styles.pipeline}>
          {STEPS.map((step, i) => (
            <React.Fragment key={step.id}>
              ...
              {i < STEPS.length - 1 && <span style={styles.connector}>→</span>}
            </React.Fragment>
          ))}
        </div>
