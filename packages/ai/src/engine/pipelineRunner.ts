...
> = {
  ...
  prd: {
    ...
    userPromptTemplate:
      'Generate a complete Product Requirements Document based on the Master Context above.\n\nInclude functional requirements, non-functional requirements, and user stories.',
    variables: [],
  ...
  srs: {
    ...
    userPromptTemplate:
      'Generate a Software Requirements Specification based on the PRD and Master Context.\n\nInclude system architecture, API design, data models, and deployment strategy.',
    variables: [],
  ...
  wireframes: {
    ...
    userPromptTemplate:
      'Generate UI wireframe descriptions based on the User Flows.\n\nInclude layouts for landing page, dashboard, and key screens.',
    variables: [],
    tags: ['design', 'ui'],
    version: 1,
  },
  roadmap: {
    ...
    userPromptTemplate:
      'Create a feature roadmap based on the PRD and Architecture.\n\nInclude MVP, growth, and enterprise phases with priorities.',
    variables: [],
    ...
    for (const step of runnableSteps) {
      ...
      try {
        ...
        if (result.conversation) {
          totalTokens +=
            (result.conversation.totalInputTokens || 0) +
            (result.conversation.totalOutputTokens || 0)
